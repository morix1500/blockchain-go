...
func NewHandler() *http.ServeMux {
	m := http.NewServeMux()
	m.HandleFunc("/transactions/new", TransactionsNewHandler)
	m.HandleFunc("/mine", MineHandler)
	m.HandleFunc("/chain", ChainHandler)
	m.HandleFunc("/nodes/register", NodeRegisterHandler)
	m.HandleFunc("/nodes/resolve", NodeResolveHandler)
